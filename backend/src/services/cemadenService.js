  ...
  for (const a of alertas) {
    try {
      const res = await pool.query(
        `INSERT INTO alerts
           (external_id, source, type, label, description, severity, status, lat, lng, municipio, starts_at, raw, tenant_id, created_at)
        ...
        [a.external_id, a.source, a.type, a.label, a.description, a.severity, a.status,
         a.lat, a.lng, a.municipio, a.starts_at, a.raw, tenantId, a.created_at]
      );
